...
export const probateFAQs: QA[] = [
  ...
  },
  {
    ...
    answer:
      `An uncontested Illinois probate at this firm is a fixed fee — ${usd(PROBATE.standard)} for a standard estate — and the written scope identifies what is included. A qualifying personal estate of $150,000 or less with no individually owned real estate may use Small Estate Administration for ${usd(PROBATE.smallEstateAdministration)}, covering the affidavit and Attorney Letter of Direction. Court filing fees, creditor publication charges, and recording fees are covered by the probate fee; a required surety-bond premium is paid directly to the provider. Where attorney fees are paid from the estate, Illinois law requires reasonable compensation under 755 ILCS 5/27-2.`,
  },
];
