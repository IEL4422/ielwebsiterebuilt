...
import { estatePlanningPackages, probatePackages, aLaCarteServices, prenuptialServices, realEstateServices, getStandardizedServiceName, type Service } from '@/lib/services-data';
...
export default function PurchaseServicePage() {
  ...
  const [serviceFilter, setServiceFilter] = useState<'all' | 'estate-planning' | 'probate' | 'prenuptial' | 'real-estate'>('all');
