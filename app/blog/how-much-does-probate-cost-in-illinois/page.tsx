          ...
          <article className="prose prose-lg max-w-none">
            ...
            <div className="bg-blue-50 border-l-4 border-[#547298] p-6 my-8 rounded-r-lg">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mb-0">
                    At Illinois Estate Law, we offer a reasonable flat fee of <strong>$5,000</strong> for standard probate &mdash; a fraction of what many hourly firms charge for the same work. Families working with hourly attorneys often pay double or triple that amount before the case is closed.
                  </p>
                </div>
              </div>
            </div>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    ...
                    <tr className="bg-green-50">
                      ...
                      <td className="py-3 px-4 font-bold text-green-700">$5,000</td>
            ...
            <div className="grid md:grid-cols-2 gap-6 my-8">
              ...
              <div className="border-2 border-green-200 rounded-lg overflow-hidden">
                ...
                <div className="p-6">
                  <div className="text-3xl font-bold text-green-600 mb-4">$5,000</div>
                  <ul className="space-y-3 text-sm">
                    <li className="flex items-start gap-2">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    A $400,000 estate in Cook County with a house, two bank accounts, and three beneficiaries. An hourly firm billed 42 hours at $350/hr = <strong>$14,700 in attorney fees alone</strong>. With our flat fee, the same family would have paid <strong>$5,000</strong> &mdash; saving over $9,000. The legal work is identical; the billing model is what makes the difference.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  {billingModel === 'hourly' ? (
                    ...
                    <div className="bg-white rounded-lg p-5 border-2 border-green-300">
                      ...
                      <div className="text-sm text-gray-500 mt-2">
                        $5,000 flat fee + court costs + publication + certified copies
                        {parseFloat(estateValue) > 200000 && ' + real estate appraisal'}
                      </div>
                    </div>
                  )}
            ...
            <div className="grid md:grid-cols-2 gap-6 my-8">
              <div className="bg-gradient-to-br from-emerald-50 to-teal-50 p-6 rounded-lg border border-emerald-200">
                ...
                <p className="text-sm text-gray-700">
                  The single most impactful decision. Our $5,000 flat fee saves families thousands compared to hourly billing &mdash; especially when cases take longer than expected or involve multiple court appearances.
                </p>
              </div>
              <div className="bg-gradient-to-br from-emerald-50 to-teal-50 p-6 rounded-lg border border-emerald-200">
                <h3 className="font-bold mb-3 flex items-center gap-2">
            ...
            <div className="bg-[#33414E] rounded-xl p-8 my-8 text-white">
              ...
              <p className="text-white/90 mb-6 leading-relaxed">
                At Illinois Estate Law, we handle standard probate for a flat fee of $5,000. No hourly billing, no surprise invoices, no meter running every time you pick up the phone. Families working with hourly law firms often pay double or triple that amount for the same legal work.
              </p>
