...
export default function Page() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        'Cost depends on the type of case. At Illinois Estate Law, an uncontested minor guardianship is handled for a flat fee, so the family knows the price up front. Adult guardianship and any contested matter are billed hourly against a retainer, because the amount of court work varies with how the case unfolds. Separate costs — such as the court filing fee and the guardian ad litem’s fee — are billed on top of attorney fees. For current figures and to find out which structure applies to your situation, see our ' +
