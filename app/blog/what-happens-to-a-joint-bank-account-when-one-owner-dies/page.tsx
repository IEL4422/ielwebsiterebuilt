      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-[1240px] mx-auto px-5 py-12">
          <article className="prose prose-lg max-w-none">
            ...
            <p className="mb-6">
              If the value of an Illinois estate may approach or exceed $4 million, working with an estate planning attorney to structure accounts and ownership in a tax-efficient manner can produce significant savings. For more detail, see our guide on <Link href="/blog/how-estate-taxes-work-in-illinois/" className="text-[#4a708b] hover:underline">how estate taxes work in Illinois</Link>.
            </p>
            ...
            <p className="mb-6">
              At Illinois Estate Law, we help clients across Chicago and Illinois assess their existing plans, restructure accounts and beneficiary designations, and create comprehensive estate plans that work the way they intend. To learn more, explore our guides on <Link href="/blog/when-is-probate-required-in-illinois/" className="text-[#4a708b] hover:underline">when probate is required in Illinois</Link>, <Link href="/blog/how-transfer-on-death-instruments-work-in-illinois/" className=\"text-[#4a708b] hover:underline">how Transfer-on-Death Instruments work</Link>, and <Link href="/chicago-revocable-trusts-lawyer/" className=\"text-[#4a708b] hover:underline">the advantages of revocable living trusts</Link>.
            </p>
