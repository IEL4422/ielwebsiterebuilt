...
const DESCRIPTION =
  'Meet the attorneys of Illinois Estate Law: Mary Liberty, Yassmin Koudmani, and Anna Rafanelli, serving clients in estate planning, probate, guardianship, and real estate throughout Illinois.';
