...
const attorneys: TeamMember[] = [
  {
    ...
    bio: [
      ...
      "Unlike traditional firms, Mary offers transparent fixed pricing for standard matters, with hourly billing reserved for contested litigation. Every client receives a written scope and price before work begins. And because her practice is entirely online, you can complete your legal process, from consultation to signed documents, without leaving your home.",
...
export function AboutContent() {
  ...
  return (
    <main>
      {/* Hero */}
      <InnerPageHero title="Meet Our Team" subtitle="Dedicated professionals committed to making estate planning and probate approachable for every Illinois family." />
