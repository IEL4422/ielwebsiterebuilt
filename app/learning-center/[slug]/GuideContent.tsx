...
export default function GuideContent({ content, isStructured, structuredSections }: GuideContentProps) {
  ...
  return (
    <div className="prose prose-lg max-w-none prose-headings:text-[#33414E] prose-headings:font-bold prose-h2:text-3xl prose-h2:mt-12 prose-h2:mb-4 prose-h3:text-2xl prose-h3:mt-8 prose-h3:mb-3 prose-p:text-gray-700 prose-p:leading-relaxed prose-li:text-gray-700 prose-li:leading-relaxed prose-strong:text-[#33414E] prose-a:text-[#4A708B] prose-a:no-underline hover:prose-a:underline prose-ul:my-4 prose-ol:my-4">
