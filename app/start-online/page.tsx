  ...
  return (
    <main>
      <InnerPageHero
        ...
        subtitle="No appointment is required to begin. Review the process, see what happens next, and move forward at your own pace."
      />
          ...
          <div className="mx-auto max-w-4xl">
                ...
                <div className="grid gap-6 bg-white px-6 py-7 sm:px-8 lg:grid-cols-[1.1fr_0.9fr]">
                  ...
                  <div className="rounded-xl border border-[#D6E1EC] bg-[#F6F9FC] p-5">
                    ...
                    <p className="mt-2 font-['Plus_Jakarta_Sans'] text-sm leading-relaxed text-slate-600">
                      This is a starting recommendation based on your answers. You can compare services or speak with the team before proceeding if your situation changes.
                    </p>
                    <Link
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-3">
              ...
              <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <h2 className="mt-4 font-['Plus_Jakarta_Sans'] text-base font-bold text-[#33414E]">2. Begin securely</h2>
                <p className="mt-2 font-['Plus_Jakarta_Sans'] text-sm leading-relaxed text-slate-600">Continue to the client portal and complete the information needed for your service.</p>
              </div>
              <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div className="mt-8 rounded-2xl border border-[#D6E1EC] bg-[#F6F9FC] p-6 sm:p-7">
              <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-center">
                <div>
                  <h2 className="font-['Plus_Jakarta_Sans'] text-xl font-bold text-[#33414E]">Ready to begin online?</h2>
